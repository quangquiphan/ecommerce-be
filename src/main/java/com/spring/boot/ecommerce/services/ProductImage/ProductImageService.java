...
public interface ProductImageService {
    ProductImage uploadImage(String path, String id, MultipartFile multipartFile, String userId) throws IOException;

    ProductImage updateImage(String path, String id, MultipartFile multipartFile, String userId) throws IOException;
